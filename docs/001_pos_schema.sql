...
INSERT INTO staffs (id, login_id, name, password_hash, role, is_active) VALUES
    (1, 'admin', '管理者', '$2y$10$I2bs2ljxuPGzPA.WMLLbLOt5EGkZUxD7gmtW9uFGD2/VYOt6yfap6', 'admin', 1)
ON DUPLICATE KEY UPDATE
    name = VALUES(name),
    role = VALUES(role),
    is_active = VALUES(is_active);
